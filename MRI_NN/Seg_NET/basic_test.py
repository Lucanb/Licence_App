...
saveDir = 'model_checkpoint_basic.pth'
...
with open('evaluation_metrics_segnet_basic.csv', mode='w', newline='') as file:
...
for epoch in range(EPOCHS):
    saveDir = f'checkpoints_basic/model_checkpoint_epoch_{epoch + 1}.pth'
...
plt.grid(True)
plt.tight_layout()
plt.savefig('train_and_testAccuracies_segnet_basic.png')
